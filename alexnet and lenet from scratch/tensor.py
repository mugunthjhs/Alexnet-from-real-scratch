...
#     print(Tensor.ones((2, 3)))
#     print(Tensor.randn(2, 2))
#     print(Tensor.rand(2, 2))
...
#     print("expand_dims")
#     print(x.expand_dims(0))

#     print("squeeze")
#     print(
#         Tensor([[[1, 2, 3]]]).squeeze()
#     )
...
#     print("sum =", r.sum())
#     print("sum axis=0 =", r.sum(axis=0))
#     print("mean =", r.mean())
#     print("mean axis=1 =", r.mean(axis=1))
#     print("max =", r.max())
#     print("max axis=1 =", r.max(axis=1))
